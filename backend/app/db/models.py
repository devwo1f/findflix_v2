...
class QuestionnaireResponse(Base):
    ...
    pacing_preference: Mapped[float | None] = mapped_column(Float, default=0.5)
    tone_preference: Mapped[float | None] = mapped_column(Float, default=0.5)
    intensity_preference: Mapped[float | None] = mapped_column(Float, default=0.5)
    runtime_preference: Mapped[str | None] = mapped_column(String(20))
    rewatch_tolerance: Mapped[str | None] = mapped_column(String(20))
